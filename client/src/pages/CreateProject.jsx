  ...
  return (
    <div className='h-[100vh] w-full'>
      ...
      {!isProject ? (
        ...
        <p className='text-zinc-500 font-semibold mt-10 text-[2vh]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore</p>
        <p className='text-zinc-500 font-semibold text-[2vh] -translate-y-[20%]'>magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea</p>
        <p className='text-zinc-500 font-semibold text-[2vh] -translate-y-[40%]'>commodo consequat. Duis aute irure dolor in reprehenderit in</p>
        <button 
